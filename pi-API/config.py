...
class Settings(BaseSettings):
    ...
    step_pulse_seconds: float = 0.0020
    step_low_seconds: float = 0.0060
    step_start_low_seconds: float = 0.0120
    step_acceleration_steps: int = 1000
    direction_settle_seconds: float = 0.005
    limit_poll_seconds: float = 0.01
    limit_debounce_seconds: float = 0.03
    homing_fast_step_seconds: float = 0.0030
    homing_slow_step_seconds: float = 0.0060
