...
export class PositionValidator {
  ...
  validatePosition(position: Position): void {
    ...
    if (
      x < this.configService.minXPosition ||
      x > this.configService.maxXPosition
    ) {
    ...
    if (
      y < this.configService.minYPosition ||
      y > this.configService.maxYPosition
    ) {
      throw new BadRequestException(
    ...
    if (
      z < this.configService.minZPosition ||
      z > this.configService.maxZPosition
    ) {
      throw new BadRequestException(
